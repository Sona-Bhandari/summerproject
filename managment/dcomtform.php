...
<div class="marginl" >
		...
		<div class="sidemenu fleft">
			<ul>
				...
				<li   id ="selectedli"><a href="dcomtview.php"><i class="fa fa-pencil fa-fw "></i> +2 Teacher</a>    </li>	
				<li><a href="bcomtview.php"><i class="fa fa-book fa-fw"></i> Bachelors.com Teacher</a>    </li>
		...
		<div class="admincontent fleft">
			<div>
					...
					<div class="fleft insert sphover">
								 <a href="dcomtview.php"><i class="fa fa-database fa-fw"></i> +2 Teacher Database</a>
					</div>
...
?>
			...
			<tr><th>Class Teacher</th><td><input type="text" name="class"  disabled value="+2" /></td>
