...
<head>
	<meta charset="UTF-8">
	<title>Bachelors COM Class Database NIST College</title>
...
<div class="marginl" >
		<div class="maintext sans"><hr>
			Bachelors Class Teacher Database <hr>
		</div>
		...
		<div class="sidemenu fleft">
			<ul>
				...
				<li ><a href="dcomtview.php"><i class="fa fa-pencil fa-fw "></i> +2 Teachers</a>    </li>	
				<li  id ="selectedli"><a href="bcomtview.php"><i class="fa fa-book fa-fw"></i> Bachelors Teachers</a>    </li>
