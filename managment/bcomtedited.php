...
<div class="marginl" >
		...
		<div class="sidemenu fleft">
			<ul>
				...
				<li   id ="selectedli"><a href="dcomtview.php"><i class="fa fa-pencil fa-fw "></i> B.com Class</a>    </li>	
		...
		<div class="admincontent fleft">
			<div>
					...
					<div class="fleft insert sphover">
								 <a href="dcomtview.php"><i class="fa fa-database fa-fw"></i> B.com All Database</a>
					</div>
