...
<div class="marginl" >
		<div class="maintext"><hr>
			Bachelors Class Database <hr>
		</div>


		<div class="sidemenu fleft">
			<ul>
				<li><a href="../index.php"><i class="fa fa-home" aria-hidden="true"></i> back to first page</a>	</li>
				<li   id ="selectedli"><a href="dcomtview.php"><i class="fa fa-pencil fa-fw "></i> D.com Teacher</a>    </li>	
				<li><a href="bcomtview.php"><i class="fa fa-book fa-fw"></i> Bachelors Teacher</a>    </li>
		...
		<div class="admincontent fleft">
			<div>
					...
					<div class="fleft insert sphover">
								 <a href="bcomtview.php"><i class="fa fa-database fa-fw"></i> Bachelors Teacher Database</a>
					</div>
...
?>
					...
					<div class='insert sphover center'>
						Bachelors New Teacher Registration
					</div>
			<table>
			...
			<tr><th>Class Teacher</th><td><input type="text" name="class"  disabled value="Bachelors" /></td>
