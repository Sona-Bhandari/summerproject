...
<head>
	<meta charset="UTF-8">
	<title>+2 Class Database NIST College</title>
...
<div class="marginl" >
		...
		<div class="sidemenu fleft">
			<ul>
				...
				<li  id ="selectedli"><a href="bcomtview.php"><i class="fa fa-book fa-fw"></i> Bachelors.com Teachers</a>    </li>
